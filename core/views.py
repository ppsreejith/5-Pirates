...
def index(request,message = ''):
    if request.user.is_authenticated():
        #message = request.user.username + ', You have been registered. Session starts on 25th Oct, 10:00 PM. Follow us on facebook. https://www.facebook.com/The.KGTS. You can login again under a different facebook account.'
